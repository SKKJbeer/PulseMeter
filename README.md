...
| `scripts/check-sicherheit.sh` | Angriffsfläche: kein Netz, kein Tracking, keine fremden Pakete, iCloud nur privat | 1 s |
...
Version **0.54.0**. Strategie, Datenmodell und Rechenkern stehen, der Klick-Dummy
...
**[Zuletzt veröffentlichter Entwurf →](https://claude.ai/code/artifact/2edb1918-62e2-4f10-9225-eb8da1c61976)**
